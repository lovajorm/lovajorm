                                ...
                                >
                                    <div className='inner'>
                                        <div className='projects'>
                                            <div className='col'>
                                                <div className='text'>
                                                    For Gute glass I have done a
                                                    static webpage in pure html,
                                                    css and javascript.
                                                </div>
                                                <a
                                            ...
                                            <div className='col'>
                                                <div className='text'>
                                                    For Gute glass I have also
                                                    done a webapplication,
                                                    should preferably be viewd
                                                    on a mobile device.
                                                    Front-end is done in React,
                                                    with a .NET core api in the
                                                    back. Firebase
